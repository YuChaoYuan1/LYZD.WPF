...
namespace ZH
{
    ...
    public class ZH1113 : IClass_Interface
    {
        ...
        /// <returns></returns>
        public int SetPulseOutput(byte contrnlType, byte bwNum, float fq1,float PWM1,int PulseNum1, float fq2, float PWM2, int PulseNum2)
        {
            ...
            rc2.SetPara(contrnlType,bwNum,(int)(fq1*100),(byte)(PWM1*100), PulseNum1, (int)(fq2 * 100), (byte)(PWM2 * 100), PulseNum2);
            rc2.Set_Cmd(0x0D);
            int ReValue = 0;
            try
            {
        ...
        /// <param name="data">00 00 遥信6 遥信5 遥信4 遥信3 遥信2 遥信1</param>
        /// <param name="FrameAry"></param>
        /// <returns></returns>
        ...
        /// 设置标准常数
        /// </summary>
        /// <param name="enlarge">o电能类型（2个标准： 00-标准电能误差相关； 01-标准时钟日记时需量）</param>
