...
namespace E_CL309
{
    ...
    internal class CL309_RequestPowerOffPacket : CL309SendPacket
    {
        ...
        {//fjk,xiugai
            ...
            if (_bCurrentDB)
            {
                byt_Value[66] = 0x0;//电流对标??????fjk TODO2:数据字典不明
            }
            else
            {
    ...
    internal class CL309_RequestPowerOnPacket : CL309SendPacket
    {
        ...
        public void SetPara(UIPara uipara, PhiPara phipara, Cus_PowerYuanJiang HABC, string str_Glys, float Hz, int iClfs, byte Xwkz, bool XieBo, bool bDBOut, bool bHuanJ, bool bBHuan, bool isNXX)
        {
            m_UIpara = uipara;
            m_Phipara = phipara;
            _Hz = Hz;
