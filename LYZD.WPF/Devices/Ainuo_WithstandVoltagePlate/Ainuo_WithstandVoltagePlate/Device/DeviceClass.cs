...
namespace ZH
{
    ...
    internal class WithstandVoltageInstrument_RequestLinkPacket : ZH1104SendPacket
    {
        ...
        public WithstandVoltageInstrument_RequestLinkPacket(byte contrnlType,byte[] data,byte bwNum)
            : base()
        {
            ContrnlType = contrnlType;
            Len = (byte)data.Length; 
            Data = data;
            BwNum = (byte)(bwNum + 0x80); 
        }
