    ...
    {/// <summary>
     ...
     /// </summary>
        ...
        public XmlHelper(string XmlFilePath)
        {
            ...
            _XmlNode = XmlHelper.LoadXml(XmlFilePath, out _ErrString);
        ...
        {
            XmlNode _XmlFind = XmlHelper.FindSencetion(_XmlNode, QueryString);
            if (_XmlFind == null)
                return (int)0;
        ...
        {
            return XmlHelper.EditNodeAttributeValues(QueryString, _XmlNode, Values);
        }
        /// <summary>
        /// 获取主节点对应子节点多个并列属性值
        /// </summary>
        ...
        {
            System.IO.FileStream _TmpStream = File.Create(SaveFilePath);
            if (_TmpStream != null)
            {
                _TmpStream.Close();
            }
