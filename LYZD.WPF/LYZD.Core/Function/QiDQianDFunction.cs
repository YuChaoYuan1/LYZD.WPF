...
namespace LYZD.Core.Function
{
    ...
    public static class QiDQianDFunction
    {
        ...
        /// <returns></returns>
        public static float getQianDongTime(float U, float xU, float qIb, float imax, string meterLevel, int MeterConst,  Enum.WireMode _Clfs, bool hgq,  Enum.Cus_Ywg _Ywg)
        {
            xU = 1.15f;
            if (hgq)
            {
        ...
        /// <returns></returns>
        public static float getQianDongTime(string GuiChengName, float U, float xU, float qIb, string MeterLevel, int MeterConst,  Enum.WireMode _Clfs,  Enum.Cus_Ywg _Ywg)
        {
            float _m = 0;
            switch (_Clfs)
            {
            ...
            else
            {
                ...
                switch (GuiChengName.ToUpper())
                {
                    ...
                    case "IR46":
                        ...
                        return 100 * 1000F / (1.1F * Errb * MeterConst * _m * U * qIb) ;
                    default:
                        {
                            return 10F * (getQiDongTime(GuiChengName, U * xU, qIb, MeterConst, _Clfs));
                        }
