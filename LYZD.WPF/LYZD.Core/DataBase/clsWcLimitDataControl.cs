...
namespace LYZD.Core.DataBase
{
    ...
    public class clsWcLimitDataControl
    {
     ...
     //   const string CONST_ACCESS = "Provider=Microsoft.Jet.OLEDB.4.0;Persist Security Info=True;Jet OLEDB:DataBase Password=;Data Source=";
        ...
        /// <param name="YouGong">是否有功</param>
        /// <returns></returns>
        public static string Wcx(string xIb, string GuiChengName, string Dj, Enum.Cus_PowerYuanJian Yj, string glys, bool Hgq, bool YouGong)
        {
            switch (GuiChengName.ToUpper())
            {
                ...
                case "JJG596-2012"://TODO2:596-2012 默认有功电能表，2、3级的无功电能表没做
                    {
                        return getLimit_JJG596_2012(xIb, Dj, Yj, glys, Hgq);
                    }
                case "IR46":
                    {
                        return GetLimit_IR46(xIb, Dj, Yj, glys, Hgq);
                    }
                default:
                    return Dj;
            }
        ...
        private static string getLimit_JJG596_1999(string xIb, string Dj, Enum.Cus_PowerYuanJian Yj, string glys, bool Hgq)
        {
            switch (Dj)
            {
                #region
        ...
        private static string GetLimit_IR46(string xIb, string Dj, Enum.Cus_PowerYuanJian Yj, string glys, bool Hgq)
        {
            switch (Dj)
            {
                #region
                ...
                case "A":
                    return GetdzA(xIb, Yj, glys);
                case "B":
                    return GetdzB(xIb, Yj, glys);
                case "C":
                    return GetdzC(xIb, Yj, glys);
                case "D":
                    if ((int)Yj == 1)  ///合元
                    {
                        return GetdzD(xIb, Yj, glys);
                    }
                    else
                    {
                        if (glys == "1.0")
        ...
        /// <param name="Hgq"></param>
        /// <returns></returns>
        private static string GetdzA(string xIb, Enum.Cus_PowerYuanJian Yj, string glys)
        {
            if (xIb.ToLower() == "ib") xIb = "1.0ib";
            float Imin = 0f; float Itr = 0f; float Imax = 0f; float Ib = 0f;
            float FloatCurrent = getFloatCurrent(xIb, out Imin, out Itr, out Imax, out Ib);
            string wcLimit = "1.0";
            ...
            {
                wcLimit = (1.5 * (Imin / FloatCurrent)).ToString("0.0");
            }
        ...
        public static float getFloatCurrent(string xIb, out float Imin, out float Itr, out float Imax, out float Ib)
        {
            string[] strCurrent = IBString.Split('-');//    App.CUS.Meters.First.Current.Split('-');
            
            string[] strCurrent1 = strCurrent[1].Split('(');
            string strImax = strCurrent1[1].Replace(")", "");
            ...
            else if (xIb.ToLower().IndexOf("ib") != -1)
            {
                ...
                {
                    FloatCurrent = float.Parse(xIb.ToLower().Replace("ib", "")) * Ib * 10;
                }
            }
            return FloatCurrent;
        }
        ...
        /// <param name="Hgq"></param>
        /// <returns></returns>
        private static string GetdzB(string xIb, Enum.Cus_PowerYuanJian Yj, string glys)
        {
            if (xIb.ToLower() == "ib") xIb = "1.0ib";
        ...
        /// <param name="Hgq"></param>
        /// <returns></returns>
        private static string GetdzC(string xIb, Enum.Cus_PowerYuanJian Yj, string glys)
        {
            if (xIb.ToLower() == "ib") xIb = "1.0ib";
            float Imin = 0f; float Itr = 0f; float Imax = 0f; float Ib = 0f;
            float FloatCurrent = getFloatCurrent(xIb, out Imin, out Itr, out Imax, out Ib);
            ...
            {
                wcLimit = (1.0 * (Imin / FloatCurrent)).ToString("0.0");
            }
        ...
        /// <param name="Hgq"></param>
        /// <returns></returns>
        private static string GetdzD(string xIb, Enum.Cus_PowerYuanJian Yj, string glys)
        {
            if (xIb.ToLower() == "ib") xIb = "1.0ib";
            float Imin = 0f; float Itr = 0f; float Imax = 0f; float Ib = 0f;
            float FloatCurrent = getFloatCurrent(xIb, out Imin, out Itr, out Imax, out Ib);
            ...
            {
                wcLimit = (0.4 * (Imin / FloatCurrent)).ToString("0.0");
            }
        ...
        /// <param name="Hgq">互感器</param>
        /// <returns></returns>
        private static string getdz002(string xIb, Enum.Cus_PowerYuanJian Yj, string glys, bool Hgq)
        {
            string _WcLimit = "";
            if (xIb.ToLower() == "ib")
            {
        ...
        /// <param name="Hgq"></param>
        /// <returns></returns>
        private static string getdz005(string xIb, Enum.Cus_PowerYuanJian Yj, string glys, bool Hgq)
        {
            string _WcLimit = "";
            if (xIb.ToLower() == "ib")
            {
        ...
        /// <param name="Hgq"></param>
        /// <returns></returns>
        private static string getdz01(string xIb, Enum.Cus_PowerYuanJian
 Yj, string glys, bool Hgq)
        {
            string _WcLimit = "";
            if (xIb.ToLower() == "ib")
            {
        ...
        /// <param name="Hgq"></param>
        /// <returns></returns>
        private static string getdz02(string xIb, Enum.Cus_PowerYuanJian
 Yj, string glys, bool Hgq)
        {
            string _WcLimit = "";
            if (xIb.ToLower() == "ib")
        ...
        /// <param name="Hgq"></param>
        /// <returns></returns>
        private static string getdz05(string xIb, Enum.Cus_PowerYuanJian
 Yj, string glys, bool Hgq)
        {
            string _WcLimit = "";
            if (xIb.ToLower() == "ib")
        ...
        /// <param name="Hgq"></param>
        /// <returns></returns>
        private static string getdz10(string xIb, Enum.Cus_PowerYuanJian
 Yj, string glys, bool Hgq)
        {
            string _WcLimit = "";
        ...
        /// <param name="Hgq"></param>
        /// <returns></returns>
        private static string getdz20(string xIb, Enum.Cus_PowerYuanJian
 Yj, string glys, bool Hgq)
        {
            string _WcLimit = "";
            if (xIb.ToLower() == "ib")
        ...
        /// <param name="Hgq"></param>
        /// <returns></returns>
        private static string getdz30(string xIb, Enum.Cus_PowerYuanJian
 Yj, string glys, bool Hgq)
        {
            string _WcLimit = "";
            if (xIb.ToLower() == "ib")
        ...
        /// <param name="YouGong">有无功</param>
        /// <returns></returns>
        private static string getGy(string xIb, string GuiChengName, string Dj, Enum.Cus_PowerYuanJian
 Yj, string glys, bool Hgq, bool YouGong)
        {
            string _WcLimit = "";
