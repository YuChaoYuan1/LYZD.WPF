...
namespace LYZD.ViewModel.InputPara
{
    ...
    public class InputParaUnit : ViewModelBase
    {
        ...
        private bool isQuickEntry = false;
        /// <summary>
        /// 是否可以快速录入
        /// </summary>
        public bool IsQuickEntry
        {
            get { return isQuickEntry; }
            set { SetPropertyValue(value, ref isQuickEntry, "IsQuickEntry"); }
        }
        private EnumQuickEntryType quickEntryType = EnumQuickEntryType.相同;
        /// <summary>
        /// 快速录入方式
        /// </summary>
        public EnumQuickEntryType QuickEntryType
        {
            get { return quickEntryType; }
            set { SetPropertyValue(value, ref quickEntryType, "QuickEntryType"); }
        }
        ...
        public enum EnumQuickEntryType
        {
            相同 = 0,
            累加 = 1
        }
