...
namespace LYZD.ViewModel.Schema
{
    ...
    public class ParaInfoViewModel : ViewModelBase
    {
        ...
        public void LoadParaInfo()
        {
            ...
            ApplyName = model.GetProperty("PARA_APPLY") as string;
        ...
        public string ApplyName
        {
            ...
            set { SetPropertyValue(value, ref applyName, "ApplyName"); }
        }
        ...
        private DynamicModel GetCurrentModel()
        {
            ...
            if (CheckParas.Count == 0)
            {
                ...
                model.SetProperty("PARA_APPLY", ApplyName);
        ...
        public void SaveParaInfo()
        {
            ...
            {
                DALManager.ApplicationDbDal.Update(EnumAppDbTable.T_SCHEMA_PARA_FORMAT.ToString(), where, model, new List<string> { "PARA_P_CODE", "PARA_VIEW", "PARA_NAME", "PARA_KEY_RULE", "PARA_VIEW_RULE", "DEFAULT_VALUE", "CHECK_CLASS_NAME", "PARA_NAME_RULE" ,"PARA_APPLY"});
            }
            else
            {
