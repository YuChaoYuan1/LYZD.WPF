...
namespace LYZD.Verify.ControlTest
{
    ...
    /// 当前功率下浮控
    /// </summary>
    public class PowerDownControl : VerifyBase
    {
        /// <summary>
        /// 检定参数是否合法
        /// </summary>
        ...
        public override void Verify()
        {
            try
            {
                ...
                WaitTime("延时等待", 65);
                SetData_698("07011481067F000202502301020811010FEC11011101110111011101110100", "投入当前功率下浮控");
                        ...
                        for (int i = 0; i < MeterNumber; i++)
                        {
                            if (meterInfo[i].YaoJianYn && !bol_Qualified[i])
                            {
                                ...
                                if (TalkResult[i] == 0)
                                {
                                    ...
                                    if (GetData(RecData, i, 12, EnumTerimalDataType.e_string).Substring(3,1) == "1")
                                    {
                ...
                SetData_698("0701198106070050230100", "控制解除_当前功率下浮控_总加组1");
