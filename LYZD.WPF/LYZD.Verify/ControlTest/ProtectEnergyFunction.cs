...
namespace LYZD.Verify.ControlTest
{
    ...
    /// 保电功能
    /// </summary>
    public class ProtectEnergyFunction : VerifyBase
    {
        /// <summary>
        /// 检定参数是否合法
        /// </summary>
        ...
        public override void Verify()
        {
            try
            {
                ...
                SetSessionData_698("07012A80017F000001" + Talkers[0].Framer698.SetDateTimeBCD(DateTime.Now, false) + "010005", "下发保电投入命令");

                MessageAdd("读终端保电状态",EnumLogType.流程信息, true);
                for (int i = 0; i < MeterNumber; i++)
                {
                    if (meterInfo[i].YaoJianYn)
                    {
                        ...
                        Talkers[i].Framer698.sAPDU = "10000805010F" + "80010200" + "00" + "0110" + Talkers[i].Framer698.cOutRand;
                ...
                AddItemsResoult("终端保电状态", TempData);

                SetSessionData_698("07012C800081000101020451F2050201110A120000030001" + Talkers[0].Framer698.SetDateTimeBCD(DateTime.Now, false) + "010005", "下发第1轮遥控跳闸命令");
                ...
                SetSessionData_698("07012F800180000001" + Talkers[0].Framer698.SetDateTimeBCD(DateTime.Now, false) + "010005", "下发保电解除命令");
                MessageAdd("读终端保电状态",EnumLogType.流程信息, true);
                for (int i = 0; i < MeterNumber; i++)
                {
                    if (meterInfo[i].YaoJianYn)
