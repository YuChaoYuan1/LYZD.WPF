...
namespace LYZD.Verify.EventRecord
{
    ...
    /// 电能表时间超差事件
    /// </summary>
    public class MeterTimeError_376 : VerifyBase
    {
        /// <summary>
        /// 检定参数是否合法
        /// </summary>
        ...
        {
            ResultNames = new string[] { "电能表时间超差事件", "禁止终端主动上报", "终端事件记录配置设置", "终端事件计数当前值", "结论" };
            return true;
        }
        public override void Verify()
        {
            try
            {
                ...
                string EventName = "电能表时间超差事件";
                MessageAdd("设置" + EventName + "有效", EnumLogType.错误信息);
                SetData = UsefulMethods.ConvertStringToBytes("00080000000000000000000000000000");
                ...
                BaseVerifyUnit_EventData(EventName, "ERC12", 4, dtHappen);
