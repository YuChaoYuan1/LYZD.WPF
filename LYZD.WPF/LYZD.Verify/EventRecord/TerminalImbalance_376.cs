...
namespace LYZD.Verify.EventRecord
{
    ...
    /// 电压/电流不平衡度越限事件
    /// </summary>
    public class TerminalImbalance_376 : VerifyBase
    {
        /// <summary>
        /// 检定参数是否合法
        /// </summary>
        ...
        {
            ResultNames = new string[] { "禁止终端主动上报", "终端事件记录配置设置", "终端事件计数当前值", "电压/电流不平衡度越限事件", "结论" };
            return true;
        }
        public override void Verify()
        {
            try
            {
                ...
                string EventName = "电压/电流不平衡度越限事件";
                 MessageAdd("设置" + EventName + "有效",EnumLogType.错误信息);
                SetData = UsefulMethods.ConvertStringToBytes("00000100000000000000000000000000");
                ...
                ControlVirtualMeter("Cmd,Set,100,220,250,5,5,5,45,45,45,1,0");
                ControlVirtualMeter("Cmd,SZT,0000,0000,0000,0004,0000,0000,0000");
                ...
                BaseVerifyUnit_EventData(EventName, "ERC17", 4, dtHappen);
