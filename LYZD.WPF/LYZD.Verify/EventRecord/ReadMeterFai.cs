...
namespace LYZD.Verify.EventRecord
{
    ...
    ///  终端485抄表错误
    /// </summary>
    public class ReadMeterFail : VerifyBase
    {
        /// <summary>
        /// 检定参数是否合法
        /// </summary>
        ...
        {
            ResultNames = new string[] { "终端485抄表错误", "结论" };
            return true;
        }
        public override void Verify()
        {
            try
            {
                ...
                SetData_698("060106310A0900030100", "设置事件有效标志");
                ...
                SetData_698_No("07 01 0A 60 14 7F 00 01 01 02 06 11 01 12 01 00 02 02 11 00 00 01 01 5B 00 00 10 02 00 5C 01 16 01 00", "下装普通采集方案");
                SetData_698_No("07 01 0B 60 12 7F 00 01 01 02 0C 11 01 54 01 00 01 16 01 11 01 1C 07 E1 08 0E 00 02 00 1C 08 33 09 09 09 09 09 54 00 00 00 11 02 16 01 12 00 00 12 00 00 02 02 16 00 01 01 02 04 11 00 11 00 11 17 11 3B 00", "下装采集任务");
                ...
                MessageAdd("读取终端故障记录485通讯故障",EnumLogType.流程信息);
                for (int i = 0; i < MeterNumber; i++)
                {
                    if (meterInfo[i].YaoJianYn)
                    {
                        ...
                        Talkers[i].Framer698.sAPDU = "1000" + GetMiWenLen(" 05 03 0C 31 0A 02 00 09 01 03 00 20 22 02 00 00 20 1E 02 00 00 20 20 02 00 00  ".Replace(" ", "")) + " 05 03 0C 31 0A 02 00 09 01 03 00 20 22 02 00 00 20 1E 02 00 00 20 20 02 00 00  ".Replace(" ", "") + "0110" + Talkers[i].Framer698.cOutRand;
                ...
                AddItemsResoult("终端485抄表错误", TempData);
