...
namespace LYZD.Verify.EventRecord
{
    ...
    /// 终端停/上电事件
    /// </summary>
    public class TerminalPowerOnAndOff_376 : VerifyBase
    {
        /// <summary>
        /// 检定参数是否合法
        /// </summary>
        ...
        public override void Verify()
        {
            try
            {
                ...
                TalkResult = TerminalProtocalAdapter.Instance.ReadEvent(14, 0, 1, RecData, ImportantEvnetCount, MaxWaitSeconds_Write);

                BaseVerifyUnit_EventData(EventName, "ERC14", 4, dtHappen);
            }
            catch (Exception ex)
            {
        ...
        {
            float ub = Xub * f_V;
            PowerOn(ub, ub, ub, 0, 0, 0, 0, 240, 120, 0, 240, 120);
