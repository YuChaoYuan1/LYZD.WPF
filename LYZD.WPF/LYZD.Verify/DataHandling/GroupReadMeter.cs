...
{
    public class GroupReadMeter : VerifyBase
    {
        public override void Verify()
        {
            ...
            AddItemsResoult("读取采集任务监控数据表地址验证", TempData);
        ...
        protected override bool CheckPara()
        {
            ...
            ResultNames = new string[] { "读取采集任务监控数据表地址验证", "电表1数据(有功电能示值)", "电表1数据(反向有功电能)", "电表2数据(有功电能示值)", "电表2数据(反向有功电能)", "结论" };
            return true;
        }
    }
