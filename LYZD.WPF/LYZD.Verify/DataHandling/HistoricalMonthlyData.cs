...
namespace LYZD.Verify.DataHandling
{
    ...
    /// 历史月数据
    /// </summary>
   public class HistoricalMonthlyData : VerifyBase
    {
        public override void Verify()
        {
            ...
            DateTime dttmp = Convert.ToDateTime(DateTime.Now.Year + "-" + DateTime.Now.Month + "-1" + " 00:00:00").AddMonths(1).AddMinutes(-1);
            SetData_698_No("07 01 06 60 14 7F 00 01 01 02 06 11 01 12 01 00 02 02 11 01 11 01 01 01 5B 01 50 06 02 00 03 20 21 02 00 00 10 02 00 00 20 02 00 5C 01 16 06 00", "下装普通采集方案");
            SetData_698_No("07 01 07 60 12 7F 00 01 01 02 0C 11 01 54 04 00 01 16 01 11 01 1C " + Talkers[0].Framer698.SetDateTimeBCD(dttmp.AddSeconds(60), false) + " 1C 08 33 09 09 09 09 09 54 01 00 01 11 02 16 01 12 00 00 12 00 00 02 02 16 00 01 01 02 04 11 00 11 00 11 17 11 3B 00", "下装采集任务");
            ...
            MessageAdd("读取电能表数据",EnumLogType.流程信息, true);
            for (int i = 0; i < MeterNumber; i++)
            {
                if (meterInfo[i].YaoJianYn)
                {
                    Talkers[i].Framer698.sAPDU = ("05 03 18 60 12 03 00 05 " + Talkers[i].Framer698.SetDateTimeBCD(dttmp.AddMinutes(1), false) + "01 05 00 20 2A 02 00 00 60 40 02 00 00 60 41 02 00 00 60 42 02 00 01 50 06 02 00 03 20 21 02 00 00 10 02 00 00 20 02 00 00 ").Replace(" ", "");
        ...
        protected override bool CheckPara()
        {
            ...
            ResultNames = new string[] { "读取采集任务监控数据", "电表1数据(有功电能示值)", "电表1数据(反向有功电能)", "电表2数据(有功电能示值)", "电表2数据(反向有功电能)", "结论" };
            return true;
        }
    }
}
