...
namespace LYZD.Verify.DataHandling
{
    ...
    /// 电能表事件补抄
    /// </summary>
    public class SupplementaryMeterEvent : VerifyBase
    {
        /// <summary>
        /// 检定参数是否合法
        /// </summary>
        ...
        {
            ResultNames = new string[] { "电能表事件补抄", "结论" };
            return true;
        }
        public override void Verify()
        {
            try
            {
                ...
                WaitTime("延时，", 120);
                MessageAdd("读取电能表时钟超差事件_虚拟表不回复", EnumLogType.流程信息);
                ...
                AddItemsResoult("电能表时间超差事件_虚拟表不回复", TempData);
