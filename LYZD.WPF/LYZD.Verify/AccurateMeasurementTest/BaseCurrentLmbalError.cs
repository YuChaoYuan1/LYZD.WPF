...
namespace LYZD.Verify.AccurateMeasurementTest
{
    ...
    /// 电流不平衡实验
    /// </summary>
    public class BaseCurrentLmbalError : VerifyBase
    {
        float ErrorLimit = 1;
        /// <summary>
        /// 检定参数是否合法
        ...
        public override void Verify()
        {
            ...
            try
            {
                ...
                MessageAdd("开始设置电流不平衡升源，B相不平衡", EnumLogType.流程信息, true);
                if (!PowerOn(OnMeterInfo.MD_UB, OnMeterInfo.MD_UB, OnMeterInfo.MD_UB, Ia, 0, Ia, 0, 240, 120, 0f, 240f, 120f))
                {
                ...
                MessageAdd("开始恢复电流", EnumLogType.流程信息, true);
