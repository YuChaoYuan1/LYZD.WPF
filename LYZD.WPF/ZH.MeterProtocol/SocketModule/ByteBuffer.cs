...
namespace System
{
    ...
    public class ByteBuffer : IDisposable
    {
        ...
        public ByteBuffer()
        {
            ...
            _encoding = Encoding.Default;//(false, true);
        ...
        {
            BaseStream = new MemoryStream(buffer, start, count, false);
        ...
        {
            return BaseStream.Seek((long)offset, origin);
        }
        ...
        {
            BaseStream.Write(value, index, count);
        }
        ...
        public void PutLong_S(long value, int pMaxLength, int pintOrder)
        {
            ...
            BaseStream.Write(retValue, 0, pMaxLength);
        }
