...
namespace ZH.MeterProtocol.SocketModule.Sock
{
    /// <summary>
    /// 与台体的通讯连接
    /// </summary>
    internal class Connection
    {
        ...
        public bool Send(Packet.SendPacket sendPack, Packet.RecvPacket recvPack, string PortName)
        {
            ...
            //if (vData.Length > 0 && vData[0] != 0x68)
            //{
            //    System.Collections.Generic.List<byte> s = new System.Collections.Generic.List<byte>();
            //    bool t = false;
