...
namespace LYZD.TerminalProtocol.Encryption
{
    ...
    /// 698直连加密机函数
    /// </summary>
    public class FactoryEncryptionFunction698
    {// <summary>
        /// 登录服务器函数
        /// </summary>
        ...
        /// <returns></returns>
        [DllImport(@"EncrypGW\DLL_SERVER_698\SocketApi.dll")]
        ...
        /// <returns></returns>
        [DllImport(@"EncrypGW\DLL_SERVER_698\SocketApi.dll")]
        public static extern int Obj_Terminal_GetTrmKeyData(int iKeyState, string cTESAMNO, string cSessionKey, string cTerminalAddress, string cKeyType, StringBuilder cOutSID, StringBuilder cOutAttachData, StringBuilder cOutTrmKeyData, StringBuilder cOutMAC);
        ...
        /// <returns></returns>
        [DllImport(@"EncrypGW\DLL_SERVER_698\SocketApi.dll")]
        public static extern int Obj_Terminal_GetTerminalSetData(int cOperateMode, string cTESAMID, string cSessionKey, string cTaskData, StringBuilder cOutSID, StringBuilder cOutAttachData, StringBuilder OutTaskData, StringBuilder cOutTaskMAC);
