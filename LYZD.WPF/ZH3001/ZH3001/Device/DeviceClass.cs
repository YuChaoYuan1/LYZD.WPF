...
namespace E_ZH3001
{
    ...
    #region ZH3001设置2204H --- 交流过量
    internal class ZH3001_RequestExcessivePacket : ZH3001SendPacket
    {
        byte Type = 0x00;
        int Bs = 1;
        int Cs = 1;
        ...
        int Ontime = 1;
        byte V = 0x00;
        public ZH3001_RequestExcessivePacket()
            : base()
        {
    
        }
        public void SetPara(byte type,int bs,int cs,int time,int ontime,byte v)
        {
            Type = type;
            Bs = bs;
            Cs = cs;
        ...
        protected override byte[] GetBody()
        {
            ...
            buf.Put(0x04);
            buf.Put(Type);
            buf.Put(GetBytesDot3(Bs));
            buf.Put(GetBytesDot3(Cs));
            buf.Put(GetBytesDot3(Time));
            buf.Put(GetBytesDot3(Ontime));
            buf.Put(V);
            return buf.ToByteArray();
        }
    ...
    internal class ZH3001_RequestExcessiveReplyPacket : ZH3001RecvPacket
    {
        protected override void ParseBody(byte[] data)
        {
            if (data == null || data.Length != 4)
    ...
    #region ZH3001设置8011H --- 锁定挡位
    internal class ZH3001_RequestGearlLockPacket : ZH3001SendPacket
    {
        public bool IsLink = true;
        ...
        public ZH3001_RequestGearlLockPacket()
            : base()
        {
        ...
        public void SetPara(double U, double IA, byte type)
        {
        ...
        protected override byte[] GetBody()
        {
            ...
            buf.Put(GetBytesDot4(u));
            buf.Put(GetBytesDot4(i));


            //buf.Put(Convert.ToByte(Type));
    ...
    internal class ZH3001_RequestGearlLockReplyPacket : ZH3001RecvPacket
    {
        protected override void ParseBody(byte[] data)
        {
            if (data == null || data.Length != 4)
