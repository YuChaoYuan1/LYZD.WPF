...
namespace ZH
{
    public class ZH3001
    {
        ...
        /// <param name="FrameAry"></param>
        /// <returns></returns>
        public int SetExcessive(byte type, int bs, int cs, int time, int ontime, byte v, out string[] FrameAry)
        {
            FrameAry = new string[1];
            ZH3001_RequestExcessivePacket rc3 = new ZH3001_RequestExcessivePacket();
            ZH3001_RequestExcessiveReplyPacket recv3 = new ZH3001_RequestExcessiveReplyPacket();
            rc3.SetPara(type, bs, cs, time, ontime, v);
            //合成的报文
            try
            {
                FrameAry[0] = BytesToString(rc3.GetPacketData());
        ...
        public int GearlLock(double U, Double I, byte v, out string[] FrameAry)
        {
            FrameAry = new string[1];
            ZH3001_RequestGearlLockPacket rc3 = new ZH3001_RequestGearlLockPacket();
            ZH3001_RequestGearlLockReplyPacket recv3 = new ZH3001_RequestGearlLockReplyPacket();
            rc3.SetPara(U, I, v);
            //合成的报文
            try
            {
